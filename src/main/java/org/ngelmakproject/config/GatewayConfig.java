...
// 				.route("auth-service-public", r -> r.path("/api/auth/authenticate", "/api/register")
// 						.filters(f -> f
...
// 				/*
// 				 * Ngelmak Core Service
// 				 * api/core/r/* (🆓 Public route — no JWT)
// 				 * api/core/*  (🔐 Protected route — requires JWT)
// 				 * 
// 				 */
